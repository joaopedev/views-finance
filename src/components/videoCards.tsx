...
const VideoCards: React.FC = () => {
  ...
  const vimeoVideoPrimeiroExperimental = 916775026;
  const vimeoVideoIdAnimation = 78493924;
  const vimeoVideoMusician = 326484284;
  const vimeoVideoSports = 912235319;
  const vimeoVideoExperimental = 918953723;
  const vimeoVideoMusicianRapper = 327010028;
  const vimeoVideoMusicianExperimental2 = 900211313;
  const vimeoVideoMusicianExperimental3 = 321785907;
  const vimeoVideoMusicianExperimental4 = 914391191;
  // const vimeoVideoMusicianExperimental5 = 901621701;
  const vimeoVideoMusicianExperimental6 = 329931228;
  const vimeoVideoMusicianExperimental7 = 328244198;
  const vimeoVideoMusicianExperimental8 = 325417533;
  const vimeoVideoMusicianExperimenta19 = 327099174;
  const vimeoVideoMusicianExperimenta20 = 888104051;
  const vimeoVideoMusicianExperimenta21 = 147539636;
  const vimeoVideoMusicianExperimenta22 = 330320418;
  const vimeoVideoMusicianExperimenta29 = 329969487;
  const vimeoVideoMusicianExperimenta30 = 910898841;
  const vimeoVideoMusicianExperimenta31 = 330962032;
  const vimeoVideoMusicianExperimenta32 = 295583887;
  const vimeoVideoMusicianExperimenta33 = 909556066;
