...
const VideoCards: React.FC = () => {
  ...
  const vimeoVideoPrimeiroExperimental = 355045867;
  const vimeoVideoIdAnimation = 340414804;
  const vimeoVideoMusician = 342760123;
  const vimeoVideoSports = 896231378;
  const vimeoVideoExperimental = 313861002;
  const vimeoVideoMusicianRapper = 340192261;
  const vimeoVideoMusicianExperimental2 = 340440547;
  const vimeoVideoMusicianExperimental3 = 346210304;
  const vimeoVideoMusicianExperimental4 = 343970762;
  const vimeoVideoMusicianExperimental5 = 919045090;
  const vimeoVideoMusicianExperimental6 = 332126100;
  const vimeoVideoMusicianExperimental7 = 346727409;
  const vimeoVideoMusicianExperimental8 = 339973295;
  const vimeoVideoMusicianExperimenta19 = 774715202;
  const vimeoVideoMusicianExperimenta20 = 333290689;
  const vimeoVideoMusicianExperimenta21 = 346746965;
  const vimeoVideoMusicianExperimenta22 = 348721737;
  const vimeoVideoMusicianExperimenta29 = 347015266;
  const vimeoVideoMusicianExperimenta30 = 348839862;
  const vimeoVideoMusicianExperimenta31 = 346913013;
  const vimeoVideoMusicianExperimenta32 = 909768963;
  const vimeoVideoMusicianExperimenta33 = 349768930;
  const vimeoVideoMusicianExperimenta34 = 362717333;
  const vimeoVideoMusicianExperimenta35 = 364941742;
  const vimeoVideoMusicianExperimenta36 = 357821778;
  const vimeoVideoMusicianExperimenta37 = 371294727;
  const vimeoVideoMusicianExperimenta38 = 371200195;
  const vimeoVideoMusicianExperimenta39 = 358813229;
  const vimeoVideoMusicianExperimenta40 = 367546671;
  const vimeoVideoMusicianExperimenta41 = 320577479;
  const vimeoVideoMusicianExperimenta42 = 328690392;
  const vimeoVideoMusicianExperimenta43 = 315487551;
  const vimeoVideoMusicianExperimenta44 = 355227695;
  const vimeoVideoMusicianExperimenta45 = 352567251;
  const vimeoVideoMusicianExperimenta46 = 372085570;
  const vimeoVideoMusicianExperimenta47 = 370491571;
  const vimeoVideoMusicianExperimenta48 = 881503269;
  const vimeoVideoMusicianExperimenta49 = 350195734;
  const vimeoVideoMusicianExperimenta50 = 315269363;
  const vimeoVideoMusicianExperimenta51 = 373759649;
  const vimeoVideoMusicianExperimenta52 = 342333493;
  const vimeoVideoMusicianExperimenta53 = 309715467;
  const vimeoVideoMusicianExperimenta54 = 328599590;
  const vimeoVideoMusicianExperimenta55 = 889793639;
