...
const VideoCards: React.FC = () => {
  ...
  const vimeoVideoPrimeiroExperimental = 581320126;
  ...
  const vimeoVideoMusicianExperimental4 = 322390692;
  const vimeoVideoMusicianExperimental5 = 340440547;
  const vimeoVideoMusicianExperimental6 = 346210304;
  const vimeoVideoMusicianExperimental7 = 346746965;
  const vimeoVideoMusicianExperimental8 = 350394309;
  const vimeoVideoMusicianExperimenta19 = 175287377;
  const vimeoVideoMusicianExperimenta20 = 364784259;
  const vimeoVideoMusicianExperimenta21 = 172129545;
  const vimeoVideoMusicianExperimenta22 = 699136294;
  const vimeoVideoMusicianExperimenta29 = 771124484;
  const vimeoVideoMusicianExperimenta30 = 251038045;
  const vimeoVideoMusicianExperimenta31 = 339973295;
  const vimeoVideoMusicianExperimenta32 = 774715202;
  const vimeoVideoMusicianExperimenta33 = 346746965;
  const vimeoVideoMusicianExperimenta34 = 333290689;
  const vimeoVideoMusicianExperimenta35 = 919045090;
  const vimeoVideoMusicianExperimenta36 = 348721737;
  const vimeoVideoMusicianExperimenta37 = 343970762;
  const vimeoVideoMusicianExperimenta38 = 347015266;
  const vimeoVideoMusicianExperimenta39 = 346210304;
  const vimeoVideoMusicianExperimenta40 = 346913013;
  const vimeoVideoMusicianExperimenta41 = 346727409;
  const vimeoVideoMusicianExperimenta42 = 421401695;
  const vimeoVideoMusicianExperimenta43 = 360257604;
  const vimeoVideoMusicianExperimenta44 = 361510934;
  const vimeoVideoMusicianExperimenta45 = 363324973;
  const vimeoVideoMusicianExperimenta46 = 363734165;
  const vimeoVideoMusicianExperimenta47 = 362469157;
  const vimeoVideoMusicianExperimenta48 = 364912471;
  const vimeoVideoMusicianExperimenta49 = 911816030;
  const vimeoVideoMusicianExperimenta50 = 365829144;
  const vimeoVideoMusicianExperimenta51 = 854724381;
