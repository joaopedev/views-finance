...
const VideoCards: React.FC = () => {
  ...
  const vimeoVideoPrimeiroExperimental = 1009280052;
  const vimeoVideoIdAnimation = 997805490;
  const vimeoVideoMusician = 1062737531;
  const vimeoVideoSports = 1061484821;
  const vimeoVideoExperimental = 1064411918;
  const vimeoVideoMusicianRapper = 1063281516;
  const vimeoVideoMusicianExperimental2 = 1062544169;
  const vimeoVideoMusicianExperimental3 = 1066595004;
  const vimeoVideoMusicianExperimental4 = 1066526515;
  const vimeoVideoMusicianExperimental5 = 1064087538;
  const vimeoVideoMusicianExperimental6 = 1062200323;
  const vimeoVideoMusicianExperimental7 = 825199507;
  const vimeoVideoMusicianExperimental8 = 847497330;
  const vimeoVideoMusicianExperimenta19 = 584013531;
  const vimeoVideoMusicianExperimenta20 = 997805490;
  const vimeoVideoMusicianExperimenta21 = 319979381;
  const vimeoVideoMusicianExperimenta22 = 956864989;
  const vimeoVideoMusicianExperimenta29 = 848119231;
  const vimeoVideoMusicianExperimenta30 = 1031379349;
  const vimeoVideoMusicianExperimenta31 = 1027047501;
  const vimeoVideoMusicianExperimenta32 = 1036181851;
  const vimeoVideoMusicianExperimenta33 = 777684384;
  const vimeoVideoMusicianExperimenta34 = 914391191;
  const vimeoVideoMusicianExperimenta35 = 462650807;
  const vimeoVideoMusicianExperimenta36 = 583566769;
  const vimeoVideoMusicianExperimenta37 = 464298473;
  const vimeoVideoMusicianExperimenta38 = 607528814;
  const vimeoVideoMusicianExperimenta39 = 535667880;
  const vimeoVideoMusicianExperimenta40 = 620172276;
  const vimeoVideoMusicianExperimenta41 = 557592709;
  const vimeoVideoMusicianExperimenta42 = 724083652;
  const vimeoVideoMusicianExperimenta43 = 568157800;
  const vimeoVideoMusicianExperimenta44 = 1063281516;
  const vimeoVideoMusicianExperimenta45 = 946171968;
  const vimeoVideoMusicianExperimenta46 = 1024184564;
  const vimeoVideoMusicianExperimenta47 = 973212054;
  const vimeoVideoMusicianExperimenta48 = 1030831285;
  const vimeoVideoMusicianExperimenta49 = 988110819;
  const vimeoVideoMusicianExperimenta50 = 1035359933;
  const vimeoVideoMusicianExperimenta51 = 1002451021;
  const vimeoVideoMusicianExperimenta52 = 1039746267;
  const vimeoVideoMusicianExperimenta53 = 1018833878;
  const vimeoVideoMusicianExperimenta54 = 1062059075;
  const vimeoVideoMusicianExperimenta55 = 1032495182;
